...
$kustoClusterInternalName = "asagadataex$($uniqueId)"
$kustoClusterName = ""
if($kustoClusterInternalName.length -gt 22){
        $kustoClusterName = $kustoClusterInternalName.substring(0, 22)
}
else{
        $kustoClusterName = $kustoClusterInternalName
}
